...
const timelineData = {
    '1996': {
        ...
        description: 'Компания Finch Industrial Tools основана тремя учредителями: А.М. Кадисом, А.Е. Власовым Начальный ассортимент формировался из столярно-слесарных инструментов нескольких голландских торговых марок. Первые шаги в мире профессионального инструмента с прицелом на качество и надежность.',
