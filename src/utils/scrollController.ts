...
export class ScrollController {
  ...
  private handleBrandsScroll(scrollDown: boolean) {
    ...
    // Правило 2: На последнем слайде (5) скролл вниз -> выход вниз
